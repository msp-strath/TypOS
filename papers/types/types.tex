...
\author{Conor McBride\inst{1}
  \and
  Fredrik Nordvall Forsberg\inst{1}
  \and
  Georgi Nakov\inst{1}
  \and
  Malin Altenm\"uller\inst{1}
  \and
  Guillaume Allais\inst{2}
  \and
  Craig Roy\inst{3}
}
...
\email{georgi.nakov.100@strath.ac.uk}\\ % TODO - is this right?
\email{malin.altenmuller.100@strath.ac.uk} % TODO - is this right?
\and
...
\email{craig.roy@cambridgequantum.com}
}

\authorrunning{}
\titlerunning{}

\title{\TypOS\!: An Operating System for Typechecking Processes}
