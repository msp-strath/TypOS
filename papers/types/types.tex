...
concurrent actors. We tackle these tasks not with a single process
traversing a syntax tree, but rather as a network of processes, each
responsible for one node of the syntax tree, communicating with the
processes for parent and child nodes via channels.
...
% Judgement declarations and thier interaction protocols 
