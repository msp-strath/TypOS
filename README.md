...
By running `typos INPUTFILE --latex-animated OUTFILE`, we can also generated
an animated trace showing the flow of information during the type
checking/synthesis process. Reusing the same [notations.tex](/build/notations.tex) file, this produces the following movie:

<img src="build/trace.gif?raw=true" alt="Typing derivation in latex format" style="width: 700px; height: auto;">
